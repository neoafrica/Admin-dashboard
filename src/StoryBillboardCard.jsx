...
import { deleteStoryBillboardImage } from './Api/post';

function StoryBillboardCard({image, desc, date, postId}) {
    ...
    const handleConfirmDelete =async () => {
        const result= await deleteStoryBillboardImage(postId)
...
export default StoryBillboardCard