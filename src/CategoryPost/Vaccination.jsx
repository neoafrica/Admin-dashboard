...
const Vaccination = ({ category }) => {
  ...
  return (
    <div className="clinical-form-container">
      <h2>🩺 Vaccination Case Details</h2>
      <form onSubmit={handleSubmit} className="clinical-form">
        ...
        />
        {errors.caseTitle && <p className="error">{errors.caseTitle}</p>}
        ...
        <label>Vaccination against:</label>
        <textarea
          name="VaccineAgainst"
          value={formData.VaccineAgainst}
          onChange={handleChange}
          placeholder="Describe vaccination against which disease(s)"
        />
        {errors.VaccineAgainst && (
          <p className="error">{errors.VaccineAgainst}</p>
        )}

        <label>Vaccination regime:</label>
        <textarea
          name="VaccinationRegime"
          value={formData.VaccinationRegime}
          onChange={handleChange}
          placeholder="Describe vaccination regime"
        />
        {errors.VaccinationRegime && (
          <p className="error">{errors.VaccinationRegime}</p>
        )}
        ...
        />
        {errors.TypeOfVaccine && (
          <p className="error">{errors.TypeOfVaccine}</p>
        )}
