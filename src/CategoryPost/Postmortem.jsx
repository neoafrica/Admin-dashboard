    ...
    <div className="clinical-form-container">
      ...
      <form onSubmit={handleSubmit} className="clinical-form">
        ...
        {errors.clinicalFindings && (
          <p className="error">{errors.clinicalFindings}</p>
        )}
        ...
        {errors.DifferentialDiagnosis && (
          <p className="error">{errors.DifferentialDiagnosis}</p>
        )}
        ...
        <textarea
          ...
          onChange={handleChange}
          placeholder="Enter tentive diagnosis"
        />
        {errors.TentativeDiagnosis && (
          <p className="error">{errors.TentativeDiagnosis}</p>
        )}
        ...
        <textarea
          ...
          onChange={handleChange}
          placeholder="Enter doctor's recommendations"
        />
        {errors.recommendations && (
          <p className="error">{errors.recommendations}</p>
        )}
